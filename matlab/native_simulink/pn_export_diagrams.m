...
for order=1:2
    ...
    print(['-s' model '/Control'],'-dpng','-r100',fullfile(folder,sprintf('controller_%d.png',order)));
    print(['-s' model '/Hardware'],'-dpng','-r100',fullfile(folder,sprintf('hardware_%d.png',order)));
end
end
